...
# article_two = Article.create(author_id: 1, title:'Singapore Airlines Commitment to purchase 20 777-3', text:'Singapore Airlines has announced its 
...
# article_two.image.attach(io: File.open("#{Rails.root}/app/assets/images/img6-16.jpg"), filename:'img6-16.jpg')
# article_three = Article.create(author_id: 1, title:'Longest fuselage', text:'The super-stretch A340-600 is Airbus’ longest jetliner operating today, 
...
# 	article_three.image.attach(io: File.open("#{Rails.root}/app/assets/images/A340-600_Airbus.jpeg"), filename:'A340-600_Airbus.jpeg')
# article_four = Article.create(author_id: 1, title:'Aircraft commonality', text:'The A340-600 also includes state-of-the-art technologies 
...
# article_four.image.attach(io: File.open("#{Rails.root}/app/assets/images/download.jpeg"), filename:'download.jpeg')
# article_five = Article.create(author_id: 1, title:'An experience to remember', text:'The A380 is a modern icon that has flown over 500,000 
...
# article_five.image.attach(io: File.open("#{Rails.root}/app/assets/images/A380-800_R.png"), filename:'A380-800_R.png')
# article_six = Article.create(author_id: 1, title:'ACH', text:'Marignane, Airbus Corporate Helicopters (ACH) has won a new order for its latest 
...
# 	worldwide.')
# article_six.image.attach(io: File.open("#{Rails.root}/app/assets/images/H145-landingPage.jpg"), filename:'H145-landingPage.jpg')
# article_seven = Article.create(author_id: 1, title:'A380: White elephant', text:'The decision to halt production of the A380 superjumbo is 
...
# 	show in 2005.')
# article_seven.image.attach(io: File.open("#{Rails.root}/app/assets/images/A-380.jpg"), filename:'A-380.jpg')
# article_eight = Article.create(author_id: 1, title:'From Boeing 777 to A:380', text:"Emirates was conceived in March 1985 with backing from Dubai's 
...
# article_eight.image.attach(io: File.open("#{Rails.root}/app/assets/images/Day_4_Flight_demo_A380-5.jpg"), filename:'Day_4_Flight_demo_A380-5.jpg')
# article_nine = Article.create(author_id: 1, title:'H125', text:"Today the renamed H125, capable of lifting its own weight in payload, is used across 
...
# article_nine.image.attach(io: File.open("#{Rails.root}/app/assets/images/Safety.jpg"), filename:'Safety.jpg')

# ArticlesCategory.create(article_id: article_one.id, category_id: 3)
# ArticlesCategory.create(article_id: article_two.id, category_id: 3)
# ArticlesCategory.create(article_id: article_three.id, category_id: 1)
# ArticlesCategory.create(article_id: article_four.id, category_id: 1)
# ArticlesCategory.create(article_id: article_five.id, category_id: 2)
# ArticlesCategory.create(article_id: article_six.id, category_id: 4)
# ArticlesCategory.create(article_id: article_seven.id, category_id: 2)
# ArticlesCategory.create(article_id: article_eight.id, category_id: 3)
# ArticlesCategory.create(article_id: article_nine.id, category_id: 4)
# Like.create(article_id: article_one.id, user_id: 1)
