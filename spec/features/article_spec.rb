...
RSpec.describe 'Article create', type: :feature do
  before do
  ...
  scenario 'Correct article creation' do
    visit new_article_path
    fill_in 'article_title', with: 'Test Article'
    fill_in 'article_text', with: 'Test Body'
    select 'TestCategory', from: 'article_articles_categories_attributes_0_category_id'
    click_on 'Create Article'
    expect(page).to have_content('The article was created succesfully.')
  end
end
